...
# Read name & usn from environment variables
default_name = os.environ.get('CAPTURE_NAME', 'unknown')
default_usn = os.environ.get('CAPTURE_USN', '000')

default_dir = f"{default_name.replace(' ', '_')}_{default_usn}"
